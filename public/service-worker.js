const CACHE_STATIC_NAME = 'aven-static-v1.0.351';
const CACHE_DYNAMIC_NAME = 'aven-dynamic-v1.0.351';
const CACHE_IMG_NAME = 'aven-images-v1.0.351'; // Caché exclusiva para imágenes pesadas
