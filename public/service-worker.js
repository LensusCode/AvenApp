const CACHE_NAME = 'chat-app-v1.1'; // Cambiamos el nombre para forzar actualización
const CACHE_DYNAMIC_NAME = 'chat-dynamic-v1.1'; // Para guardar datos de la API (historial)
