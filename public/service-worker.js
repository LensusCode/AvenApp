const CACHE_STATIC_NAME = 'aven-static-v1.0.35';
const CACHE_DYNAMIC_NAME = 'aven-dynamic-v1.0.35';
const CACHE_IMG_NAME = 'aven-images-v1.0.35'; // Caché exclusiva para imágenes pesadas
